...
import { normalizeSampleData, SAMPLE_SCHEMA } from '@xyo-network/autodrive-sample-protocol'
...
describe('official Auto Drive storage adapter', () => {
  ...
  it('stores only the canonical application payload, reads it afresh, and reconciles duplicates after reopening', async () => {
    const storage = await create()
